...
nice -n -20 gst-launch-0.10 filesrc location=./tests/pedestrian_area/pedestrian_area_dec.yuv ! videoparse format=1 width=1920 height=1080 framerate=25/1 ! ffmpegcolorspace ! xvidenc ! avimux ! filesrc location=./tests/pedestrian_area/results/pedestrian_area_1_1.avi
...
nice -n -20 ./ldecod.exe -f ./tests/pedestrian_area/decoder.cfg 
nice -n -20 gst-launch-0.10 filesrc location=./tests/pedestrian_area/pedestrian_area_dec.yuv ! videoparse format=1 width=1920 height=1080 framerate=25/1 ! ffmpegcolorspace ! xvidenc ! avimux ! filesrc location=./tests/pedestrian_area/results/pedestrian_area_5_10.avi
...
nice -n -20 ./ldecod.exe -f ./tests/pedestrian_area/decoder.cfg 
nice -n -20 gst-launch-0.10 filesrc location=./tests/pedestrian_area/pedestrian_area_dec.yuv ! videoparse format=1 width=1920 height=1080 framerate=25/1 ! ffmpegcolorspace ! xvidenc ! avimux ! filesrc location=./tests/pedestrian_area/results/pedestrian_area_10_30.avi
...
nice -n -20 ./ldecod.exe -f ./tests/pedestrian_area/decoder.cfg 
nice -n -20 gst-launch-0.10 filesrc location=./tests/pedestrian_area/pedestrian_area_dec.yuv ! videoparse format=1 width=1920 height=1080 framerate=25/1 ! ffmpegcolorspace ! xvidenc ! avimux ! filesrc location=./tests/pedestrian_area/results/pedestrian_area_10_60.avi
