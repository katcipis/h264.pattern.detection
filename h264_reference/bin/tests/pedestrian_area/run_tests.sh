...
cp ./tests/pedestrian_area/pedestrian_area.h264 ./tests/pedestrian_area/results/pedestrian_area_original.h264

echo "=== Starting 1/1 test ==="

./lencod.exe -f ./tests/pedestrian_area/encoder_1_1.cfg &> ./tests/pedestrian_area/results/encoder_1_1.res

cp ./tests/pedestrian_area/pedestrian_area.h264 ./tests/pedestrian_area/results/pedestrian_area_1_1.h264
...
cp ./tests/pedestrian_area/pedestrian_area.h264 ./tests/pedestrian_area/results/pedestrian_area_5_10.h264
...
cp ./tests/pedestrian_area/pedestrian_area.h264 ./tests/pedestrian_area/results/pedestrian_area_10_30.h264
...
cp ./tests/pedestrian_area/pedestrian_area.h264 ./tests/pedestrian_area/results/pedestrian_area_10_60.h264
