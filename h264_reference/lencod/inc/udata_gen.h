...
/*!
 *****************************************************************************************
 * Generates a SEI NALU that with ONE unregistered userdata SEI message with random data.
 *
...
/*!
 *******************************************************************************************
 * Generates random 0 terminated string to be sent on a SEI NALU. The size of the message is
 * random too, but it will not exceed MAXNALUSIZE.
 *
