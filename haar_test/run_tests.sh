...
gst-launch -v filesrc location=./videos/crowd_run_1080p50.y4m ! decodebin2 ! filesink location=./videos/crowd_run_1080p.yuv
gst-launch -v filesrc location=./videos/blue_sky_1080p25.y4m ! decodebin2 ! filesink location=./videos/blue_sky_1080p.yuv
gst-launch -v filesrc location=./videos/speed_bag_1080p.y4m ! decodebin2 ! ffmpegcolorspace ! video/x-raw-yuv,format=\(fourcc\)I420 ! filesink location=./videos/speed_bag_1080p.yuv
...
gst-launch -v filesrc location=./videos/news_cif.y4m ! decodebin2 ! filesink location=./videos/news_cif.yuv

echo ""
echo "Generating 720p YUV videos"
echo ""

gst-launch -v filesrc location=./videos/crowd_run_1080p50.y4m ! decodebin2 ! videoscale ! video/x-raw-yuv,width=1280,height=720 ! filesink location=./videos/crowd_run_720p.yuv
gst-launch -v filesrc location=./videos/blue_sky_1080p25.y4m ! decodebin2 ! videoscale ! video/x-raw-yuv,width=1280,height=720 ! filesink location=./videos/blue_sky_720p.yuv
gst-launch -v filesrc location=./videos/speed_bag_1080p.y4m ! decodebin2 ! ffmpegcolorspace ! video/x-raw-yuv,format=\(fourcc\)I420 ! videoscale ! video/x-raw-yuv,width=1280,height=720 ! filesink location=./videos/speed_bag_720p.yuv

echo ""
echo "Generating 640 x 360 YUV 4:2:0 video"
echo ""

gst-launch -v filesrc location=./videos/crowd_run_1080p50.y4m ! decodebin2 ! videoscale ! video/x-raw-yuv,width=640,height=360 ! filesink location=./videos/crowd_run_640_360.yuv
gst-launch -v filesrc location=./videos/speed_bag_1080p.y4m ! decodebin2 ! ffmpegcolorspace ! video/x-raw-yuv,format=\(fourcc\)I420 ! videoscale ! video/x-raw-yuv,width=640,height=360 ! filesink location=./videos/speed_bag_640_360.yuv
